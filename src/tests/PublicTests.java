...
public class PublicTests extends TestCase {
	...
	//these are tests I used with the large data set, I commented them out because the large data set is unavailable when submitting
	/*public void testSys6() throws Exception, Throwable {
		TestingSupport.redirectStandardInputTo("pubTest6.txt");
		OrdersProcessor.main(null);
	}
	
	public void testSys7() throws Exception, Throwable {
		TestingSupport.redirectStandardInputTo("pubTest7.txt");
		OrdersProcessor.main(null);
	}*/   
	/**
